...
import { 
  ...
  Mail, BarChart3, Cog, Server, Activity, Crown
} from 'lucide-react';

// Royal Purple - Left sidebar with deep purple accents (inspired by Design5/Design13)
const Design10 = () => {
  const devices = [
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-50">
        <div className="flex items-center justify-between px-6 h-14">
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="px-4 py-2 bg-purple-600 text-white rounded-lg text-sm font-medium flex items-center gap-2 hover:bg-purple-700">
            ...
            {[
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all ${
                  item.active ? 'bg-purple-50 text-purple-700 font-medium' : 'text-gray-600 hover:bg-gray-50'
                }`}
              >
        ...
        <main className="flex-1 p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="relative">
              ...
              <input type="text" placeholder="Search devices..." className="pl-10 pr-4 py-2 border border-gray-300 rounded-lg text-sm w-64 focus:outline-none focus:ring-2 focus:ring-purple-500" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-4 gap-4 mb-6">
            {[
              { label: 'Total', value: '24', bg: 'bg-purple-50', text: 'text-purple-700', icon: Cpu },
              ...
              <tbody>
                {devices.map((device) => (
                  <tr key={device.id} className="border-t border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-purple-600">{device.assigned || <span className="text-gray-400">—</span>}</td>
