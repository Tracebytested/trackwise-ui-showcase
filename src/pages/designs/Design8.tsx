...
import { 
  ...
  Mail, BarChart3, Cog, Server, Activity, Hexagon
} from 'lucide-react';

// Slate Minimal - Clean light sidebar with slate tones (inspired by Design5/Design13)
const Design8 = () => {
  const devices = [
      ...
      <header className="bg-white border-b border-slate-200 sticky top-0 z-50">
        <div className="flex items-center justify-between px-6 h-14">
          ...
          <div className="flex items-center gap-3">
            ...
            <button className="px-4 py-2 bg-slate-800 text-white rounded-lg text-sm font-medium flex items-center gap-2 hover:bg-slate-900">
            ...
            {[
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm transition-all ${
                  item.active ? 'bg-slate-100 text-slate-900 font-medium' : 'text-slate-600 hover:bg-slate-50'
                }`}
              >
        ...
        <main className="flex-1 p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <div className="relative">
              ...
              <input type="text" placeholder="Search devices..." className="pl-10 pr-4 py-2 border border-slate-300 rounded-lg text-sm w-64 focus:outline-none focus:ring-2 focus:ring-slate-500" />
            </div>
          </div>
          ...
          <div className="grid grid-cols-4 gap-4 mb-6">
            {[
              { label: 'Total', value: '24', bg: 'bg-slate-100', text: 'text-slate-800', icon: Cpu },
              ...
              <tbody>
                {devices.map((device) => (
                  <tr key={device.id} className="border-t border-slate-100 hover:bg-slate-50">
                    ...
                    <td className="px-6 py-4 text-slate-700">{device.assigned || <span className="text-slate-400">—</span>}</td>
